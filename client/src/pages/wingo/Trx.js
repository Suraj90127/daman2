      ...
      >
        ...
        <div className="grid grid-cols-12 nav-bg rounded-xl">
          ...
          >
            ...
            <p
              className={`text-center  fs-sm font-sans leading-4 ${
                activeTime == 11 ? "text-white" : "gray-100"
              }`}
            >
              Trx Win Go <br /> 1Min
            </p>
          ...
          >
            ...
            <p
              className={`text-center  fs-sm font-sans leading-4 ${
                activeTime == 33 ? "text-white" : "gray-100"
              }`}
            >
              Trx Win Go <br /> 3Min
            </p>
          ...
          >
            ...
            <p
              className={`text-center  fs-sm font-sans leading-4 ${
                activeTime == 55 ? "text-white" : "gray-100"
              }`}
            >
              Trx Win Go <br /> 5Min
            </p>
          ...
          >
            ...
            <p
              className={`text-center  fs-sm font-sans leading-4 ${
                activeTime == 100 ? "text-white" : "gray-100"
              }`}
            >
              Trx Win Go <br /> 10Min
            </p>
        ...
        <div className="trx-period-bg flex justify-between mt-5 rounded-lg p-2">
          <div>
            <div className="flex items-center">
              <p className="border rounded-md px-2  text-white text-sm mr-1 py-[1px]">
                Period
              </p>
              <button
        ...
        {gameHistory == "ghistory" && (
          <div>
            <div className="grid grid-cols-10 blue-linear text-white rounded-t-md p-2 mt-5">
              ...
              wingoPeriodListData.data.gameslist.map((item, i) => (
                <div className="grid grid-cols-10 nav-bg p-2 py-3" key={i}>
                  ...
                  `}
                    ...
                    <span
                      className={`text-sm ms-2 text-white flex justify-center items-center ${
