...
import { TbCircleNumber8Filled, TbHexagonLetterBFilled, TbHexagonLetterSFilled, TbHexagonNumber0Filled, TbHexagonNumber1Filled, TbHexagonNumber2Filled, TbHexagonNumber3Filled, TbHexagonNumber4Filled, TbHexagonNumber5Filled, TbHexagonNumber6Filled, TbHexagonNumber7Filled, TbHexagonNumber9Filled } from "react-icons/tb";
import './Page.css'
const bettingData = [
    ...
    <div>
      <div className="bg-background p-2 rounded-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 nav-bg p-4">
          ...
          >
            ...
            <p className="text-lg font-medium gray-50">5D 1P</p>
          </div>
          ...
          >
            ...
            <p className="text-lg font-medium gray-50">5D 3P</p>
          </div>
          <div className="bg-accent text-white border border-color-slat p-2 bg-color-l flex items-center gap-2 rounded-md "
          >
            <p className="text-4xl  p-2 rounded bgs-yellow-600">5M</p>
            <p className="text-lg font-medium gray-50">5D 5P</p>
          </div>
          <div className="bg-accent text-white border border-color-slat p-2 bg-color-l flex items-center gap-2 rounded-md "
          >
            <p className="text-4xl   p-2 rounded bgs-yellow-600">10M</p>
            <p className="text-lg font-medium gray-50">5D 10P</p>
          </div>
        </div>
      </div>
        ...
        <div className=" p-4 rounded-lg shadow-lg h-[400px] overflow-hidden">
          <div className="space-y-2 animate-scroll">
            {bettingData.map((item) => (
              <div key={item.id} className="flex items-center justify-between bg-red-500 p-2 rounded-sm">
      ...
      <div className="nav-bg mt-5 rounded-lg">
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-border border-color-slat">
